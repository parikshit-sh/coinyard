          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row">
              <input
                ...
                className="dark:bg-gray-700 bg-gray-200  px-4 py-2 
                rounded-l-md 
                focus:outline-none focus:ring-2
                 focus:ring-blue-500 mb-2 sm:mb-0 text-white"
              />
              <button
                type="submit"
          ...
          <div className="flex space-x-4 mt-4 sm:mt-0">
            {[FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn].map((Icon, index) => (
              <a
                key={index}
                href="#"
                className="text-zinc-700 dark:text-gray-300 dark:hover:text-white transition-colors duration-300"
                target="_blank"
