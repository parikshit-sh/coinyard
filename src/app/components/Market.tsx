    ...
    <div className="py-4 pt-20 px-4 md:px-8 lg:px-16" id="market">
      ...
      {loading ? (
        ...
        <motion.div
          ...
          className="overflow-x-auto bg-white dark:bg-[#121212] shadow-lg rounded-lg"
        >
          <table className="min-w-full divide-y divide-gray-200 dark:divide-white">
            <thead className="bg-gray-50 dark:bg-[#121212] mt-2">
              <tr>
                {[
                  "Name",
                  "Price",
            ...
            <tbody className="bg-white dark:bg-[#121212] divide-y divide-gray-200 dark:divide-white">
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      />
                      <span
                        className="font-medium font-mPlus
                  ...
                  <td
                    className={`px-6 py-4 whitespace-nowrap text-sm font-medium font-mPlus ${
          ...
          <div
            className="px-6 py-4 flex items-center justify-between border-t border-gray-200 dark:border-white
           bg-gray-50 dark:bg-[#121212]"
          >
            <div className="inline-flex mx-auto  justify-between sm:hidden">
              <button
                onClick={() => handlePageChange(currentPage - 1)}
                disabled={currentPage === 1}
                className="inline-flex mx-auto justify-center items-center px-4 py-2 border border-gray-300
                 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 dark:bg-[#121212] dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700 font-mPlus"
              >
                Previous
              </button>
              <button
                ...
                className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300
                 text-sm font-medium rounded-md text-gray-700 bg-white
                  hover:bg-gray-50 dark:bg-[#121212] dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700 font-mPlus"
              >
                Next
              </button>
            </div>
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  ...
                  of{" "}
                  <span className="font-medium font-mPlus">{data.length}</span>{" "}
                  results
                </p>
              </div>
                ...
                >
                  <button
                    ...
                    border border-gray-300 bg-white text-sm font-medium text-gray-500
                     hover:bg-gray-50 dark:bg-[#121212] dark:text-gray-200 dark:border-gray-600
                    ...
                    <button
                      ...
                      className={`relative flex items-center px-4 py-2 border text-sm font-medium ${
                        num === currentPage
                          ...
                          : "bg-white border-gray-300 text-gray-500 hover:bg-gray-50 dark:bg-[#121212] dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700"
                      }`}
                    >
                      {num}
                    </button>
                  ...
                  <button
                    onClick={() => handlePageChange(currentPage + 1)}
                    disabled={currentPage === totalPages}
                    className="relative flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 dark:bg-[#121212]
